...
const Collaborators = () => {
  const collaborators = [
    { name: 'TechOn Industries', logo: collab1, images: [collab1, collab2], description: 'Leading technology solutions provider specializing in enterprise software, cloud infrastructure, and digital transformation. Partnership since 2020.' },
    { name: 'Innovation Labs', logo: collab2, images: [collab2], description: 'Research and development partner focused on emerging technologies including AI, IoT, and blockchain. Joint research initiatives and student internships.' },
    { name: 'Academic Alliance University', logo: collab3, images: [collab3], description: 'Premier educational institution providing academic resources, venue support, and faculty mentorship for society events and programs.' }
  ];
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-orbitron font-black mb-6 text-primary">Collaborators</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Partnering with industry leaders and innovators to create meaningful impact</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {collaborators.map((collab, index) => (
              <Card
                key={index}
                onClick={() => { setSelected(index); setOpen(true); }}
              ...
              >
                ...
                <CardContent className="p-6">
                  <h3 className="text-2xl md:text-3xl font-orbitron font-bold mb-3 text-primary">{collab.name}</h3>
                  <p className="text-muted-foreground leading-relaxed line-clamp-3">{collab.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="mt-16 bg-card rounded-2xl p-8 md:p-12 border-2 border-primary/50 text-center animate-scale-in">
            ...
            <Link
              ...
              className="inline-block w-full md:w-auto px-8 py-3 rounded-2xl font-orbitron text-lg 
                         bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-all"
            >
              Contact Us
            </Link>
          </div>
